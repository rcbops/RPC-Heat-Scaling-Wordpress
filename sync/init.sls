...
{{ sync.xinetd_path }}/csync2:
  file.managed:
    - source: salt://scaling_wordpress/sync/files/xinetd.d/csync2
    - template: jinja
    - mode: 644
    - user: root
    - group: root
...
{{ sync.csync2_path }}/csync2.key:
  file.managed:
    - source: salt://scaling_wordpress/sync/files/csync2/csync2.key
    - mode: 600
    - requires:
...
{{ sync.csync2_path }}/csync2.cfg:
  file.managed:
    - source: salt://scaling_wordpress/sync/files/csync2/csync2.cfg
    - template: jinja
    - mode: 644
    - user: root
    - group: root
...
{{ sync.csync2_path }}/csync2_{{ clean_hostname }}.cfg:
  file.managed:
    - source: salt://scaling_wordpress/sync/files/csync2/directional.cfg
    - template: jinja
    - user: root
    - group: root
    - mode: 644
...
/etc/lsyncd/lsyncd.conf.lua:
  file.managed:
    - source: salt://scaling_wordpress/sync/files/lsyncd/lsyncd.conf.lua
    - makedirs: True
    - template: jinja
    - user: root
    - group: root
